  ...
  <div class="row">
    ...
    <div class="col s12 m8 offset-m2 l8 offset-l2 center" style="margin-top:25px;">
      ...
      <div class="card-panel white">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ url('conduct/' . $conduct->id)}}">
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <img class="responsive-img" src=" {{ asset($conduct->path_image) }} " />
            </div>
          </div>
          ...
          <div class="row">
            <div class="input-field col s12">
              <input id="text" type="text" class="validate" name="text" value="{{ $conduct->text }}" />
